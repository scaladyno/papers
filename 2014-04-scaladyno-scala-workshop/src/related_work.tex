...
A pitfall in dynamic languages is allowing patterns such as monkey patching and duck typing, such as, for example, in JavaScript. These patterns, once used, make the code base impossible to typecheck, since proving their correctness can, in adversarial cases, require solving the termination problem, which is undecidable.
