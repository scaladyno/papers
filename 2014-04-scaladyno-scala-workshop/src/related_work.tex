...
Typed Racket \cite{racket} as well as Strongtalk (a Smalltalk dialect with optional static typing support) \cite{strongtalk}, are other examples of brining static typing to a dynamic language.
